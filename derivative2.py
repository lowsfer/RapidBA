...
def gvec2mat(g0, g1, g2):
    ...
    for i in range(3):
        for j in range(3):
            # Note about [j,i]. The paper use a x*R for rotation, thus is different from the fomula wikipedia page. We use R*x convention
...
g0, g1, g2, c0, c1, c2 = symbols('g0, g1, g2, c0, c1, c2', real=True, commutative=True)
g = Matrix([g0, g1, g2])
c = Matrix([c0, c1, c2])
...
x0, x1, x2 = symbols('x0, x1, x2', real=True, commutative=True)
x = Matrix((x0,x1,x2))
(r*R*(x - c)).jacobian([g0, g1, g2]).subs({g0:0,g1:0,g2:0})



##############
fx, fy, cx, cy, k1, k2, p1, p2, k3 = symbols('fx, fy, cx, cy, k1, k2, p1, p2, k3', real=True, commutative=True)
